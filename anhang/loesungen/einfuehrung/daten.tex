...
\begin{enumerate}
\item Die Zahl \num{65536} (\say{altes} Skript) wird zu $00010000000000100000000010000000000010000001000000$ codiert. Die Zahl \num{512} (\say{neues} Skript) wird zu $000010000000000000100000000100$ codiert.
...
\item O mit UTF-16: 0000000001001111
\item O mit UTF-8: 01001111
\end{enumerate}
\item Code Point: U+00A9 und UTF-8: $C2A9_{16} = 1100001010101001_2$
\item Code Point: U+20AC und UTF-8: $E282AC_{16} = 111000101000001010101100_2$
\item Code Point: U+1F600 und UTF-8: $F09F9880_{16} = 11110000100111111001100010000000_2$
...
\item Decodierung der Textdateien:
\begin{enumerate}
\item Jedes Zeichen ist ein lateinischer Buchstabe. Jedes Zeichen benötigt \qty{8}{\bit}. Es muss UTF-8 sein.
\item Jedes Zeichen ist ein lateinischer Buchstabe. Wäre es UTF-8, dann benötigt man pro Zeichen nur \qty{8}{\bit}. Es sind aber pro Zeichen \qty{16}{\bit}. Es muss also UTF-16 sein.
\item Jedes Zeichen benötigt \qty{32}{\bit}. Es muss UTF-32 sein, da auch die lateinischen Buchstaben \qty{32}{\bit} verwenden.
\item Jedes Zeichen benötigt \qty{16}{\bit} oder \qty{32}{\bit}. Es muss UTF-16 sein. Es ist nicht UTF-8, da die lateinischen Buchstaben sonst nur \qty{8}{\bit} benötigen würden.
\item Manche Zeichen benötigen \qty{8}{\bit} andere Zeichen \qty{16}{\bit} (z.B. das Zeichen vor dem $b$) oder sogar \qty{32}{\bit} (das letzte Zeichen ist das Fondue-Emoji). Es muss UTF-8 sein, da nur dort die Anzahl der Bits so variabel ist.
\item Jedes Zeichen benötigt \qty{32}{\bit}. Es muss UTF-32 sein, da auch die lateinischen Buchstaben \qty{32}{\bit} verwenden.
\end{enumerate}
\end{enumerate}
...
\begin{enumerate}
\item $0D_{16} = 00001101_2$
\item $10_{16} = 00010000_2$
\item $80_{16} = 10000000_2$
