...
Der Zeichenvorrat, das heisst die Menge der möglichen Zeichen, die ein Code für die Codierung zur Verfügung stellt.
\end{definition}
...
Im September 2021 ist die Version 14.0 von Unicode erschienen. Es kamen \num{838} neue Zeichen hinzu (darunter sind \num{37} neue Emojis) und der Code umfasst nun \num{144697} Zeichen. Unicode ist so konzipiert, dass auch in der Zukunft noch mehr Zeichen aufgenommen werden können. Der Code hat \say{Platz} für insgesamt \num{1114112} Code-Wörter. Somit sind zurzeit knapp \qty{13}{\percent} benutzt.
...
U+0001 0000 bis U+0010 FFFF	& \qty{4}{\byte}      	& 1110xxxx 10xxxxxx 10xxxxxx 10xxxxxx       \\ \hline
\end{tabular}
...
\begin{itemize}
\item Der Code Point U+0041, das Zeichen A, liegt im ersten Bereich (0\textcolor{blue}{xxxxxxxx}). Wir codieren 41 zu 0\textcolor{blue}{1000001}. Wir nehmen die letzten \qty{7}{\bit} und erstellen das UTF-8 Code-Wort 0\textcolor{blue}{1000001}.
\item Der Code Point U+00DF, das Zeichen ß, liegt im zweiten Bereich. Wir codieren DF zu 11011111. Wir ersetzen die Platzhalter (\say{x}) von \textbf{rechts} nach \textbf{links} durch die Bits. Alle übrig gebliebenen Platzhalter werden durch eine \num{0} ersetzt.
...
Wir erhalten das UTF-8 Code-Wort 11000011 10011111. Es besteht aus \qty{2}{\byte}.
\end{itemize}
\end{example}
...
\begin{enumerate}
\item Notieren Sie den Code Point.
\fillwithgrid{0.25in}
\item Codieren Sie den Code Point mit UTF-32.
\fillwithgrid{0.25in}
\item Codieren Sie den Code Point mit UTF-16.
\fillwithgrid{0.25in}
...
\fillwithgrid{1in}
\item UTF-8 erweitert \ac{ASCII} und ist in der Lage ein Code-Wort aus \ac{ASCII} zu decodieren. Erklären Sie, warum das für jedes Code-Wort aus \ac{ASCII} möglich ist.
\fillwithgrid{\stretch{1}}

\newpage

\item Erkunden Sie im \ac{WWW} für welche Emoji-Kategorie keine neuen Vorschläge mehr angenommen werden. Warum?
\fillwithgrid{1.5in}
\item Laden Sie aus Microsoft Teams die sechs Textdateien herunter. Gehen Sie dann auf \url{www.hexed.it}. Öffnen Sie die Dateien und finden Sie die Codierung der Textdateien heraus. Notieren Sie jeweils eine kurze Begründung.
\begin{enumerate}
\item \texttt{unbekannter\_code\_1.txt}
\fillwithgrid{0.75in}
\item \texttt{unbekannter\_code\_2.txt}
\fillwithgrid{0.75in}
\item \texttt{unbekannter\_code\_3.txt}
\fillwithgrid{0.75in}
\item \texttt{unbekannter\_code\_4.txt}
\fillwithgrid{0.75in}
\item \texttt{unbekannter\_code\_5.txt}
\fillwithgrid{0.75in}
\item \texttt{unbekannter\_code\_6.txt}
\fillwithgrid{0.75in}
\end{enumerate}
\end{enumerate}