...
Ein Code besteht aus Eingabedaten und Ausgabedaten. Das Umwandeln von Eingabedaten in Ausgabedaten nennt man Codieren. Beim Codieren entstehen Code-Wörter. Wandelt man ein Code-Wort zurück, dann spricht man von Decodieren. 
\end{definition}
...
Es müssen dabei nur Wörter eindeutig decodierbar sein, welche zuvor korrekt codiert wurden. Nicht jedes beliebige Wort muss somit (eindeutig) decodierbar sein.
