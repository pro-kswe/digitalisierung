...
\fillwithgrid{1in}
\item Ein Unternehmen verkauft Notebooks mit verschiedenen Arbeitsspeichergrössen. Auf seinen Datenblättern gibt er die Speichergrössen, so wie im Handel üblich, mit dem Umwandlungsfaktor $10^3$ an. Das Notebook wird mit  \qty{4}{\giga\byte} beworben. Wie viele Bytes erhalten Sie laut Datenblatt?
\fillwithgrid{1in}
